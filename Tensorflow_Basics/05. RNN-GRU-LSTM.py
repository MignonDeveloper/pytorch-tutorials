...
model.add(layers.SimpleRNN(units=512, return_sequences=True, activation="relu"))
# untis: Positive integer, dimensionality of the output space.
...
model = keras.Sequential()
model.add(keras.Input(shape=(None, 28)))
model.add(layers.SimpleRNN(units=256, return_sequences=True, activation="tanh"))
